...
class WordGenerator {
  ...
  static let possibleWords = ["APPLE", "TABLE", "CHAIR", "WATER", "GRAPE", "QUEEN", "HOUSE", "PLANT", "OCEAN", "DREAM", "LIGHT", "HORSE", "AMBER", "STARS", "TRAIN", "LUNCH", "PEACH", "MAPLE", "RIVER", "WATCH", "FLAME", "BREAD", "CLOUD", "SHOES", "LAUGH", "SMILE", "BENCH", "DANCE", "EARTH", "HAPPY", "JELLY", "TIGER", "LEMON", "MUSIC", "PAPER", "SPACE", "BRUSH", "CROWN", "SNAKE", "SOLID", "ANGEL", "STORM", "WINGS", "CLOCK", "MAGIC", "PUPPY", "PIZZA", "ROBOT", "MOUSE"]
